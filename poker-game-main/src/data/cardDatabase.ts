...
export const allCardDefinitions = [
  ...
  // 031. 强盗
  {
    ...
    effects: [
    {
      timing: 'onReveal',
      type: 'conditional',
      description: '揭示：选择一名其他玩家，对方需要将一张手牌交给你；如果场上存在“士兵”关键词的卡牌，这张牌的战力-3'
    }
    ],
    slotRequired: 1,
    isPersistent: true
  ...
  // 034. 武僧
  {
    ...
    effects: [
    {
      timing: 'onDeploy',
      type: 'conditional',
      description: '每当你为这张卡牌打出一张战术牌后，这张牌的战力便+1'
    }
    ],
    slotRequired: 1,
    isPersistent: true
  ...
  // 038. 纪念照
  {
    ...
    effects: [
    {
      timing: 'onDeploy',
      type: 'conditional',
      description: '这张牌无法被打出，如果你的场上拥有环境牌以及“摄像机”和“游客”名称的卡牌，那么在游戏结束时这张牌拥有4点战力'
    }
    ],
    slotRequired: 1,
    isPersistent: true
  ...
  // 039. 金矿
  {
    ...
    effects: [
    {
      timing: 'onDeploy',
      type: 'conditional',
      description: '这张牌无法被打出，如果游戏结束时这是你唯一的手牌，这张牌的战力变为7点！'
    }
    ],
    slotRequired: 1,
    isPersistent: true
  ...
  // 110. 帆船
  {
    ...
    effects: [
    {
      timing: 'onDeploy',
      type: 'conditional',
      description: '你必须在场上拥有水属性的环境牌时才能打出这张牌，复制一张水属性的环境牌效果'
    }
    ],
    slotRequired: 1,
    isPersistent: true
