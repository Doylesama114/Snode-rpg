...
export const allCardDefinitions = [
  ...
  // 119. 寒脊山脉
  {
    ...
    effects: [
    {
      ...
      targetAllCards: true,
      excludeAttributes: ['冰'],
      description: '每个回合结束时，所有角色场上非冰属性的卡牌战力-1'
    },
    {
      timing: 'roundEnd',
      type: 'modifyPower',
      ...
      targetAllCards: true,
      targetAttributes: ['冰'],
      description: '每个回合结束时，冰属性的卡牌战力+1'
    }
    ],
    slotRequired: 1,
    isPersistent: true
  ...
  // 152. 鲁特琴
  {
    ...
    effects: [
    {
      ...
      type: 'deployOnHostOnly',
      requireHostCardType: 'unit',
      requireHostKeywords: ['吟游诗人'],
      description: '这张牌可以被部署在「吟游诗人」卡牌上'
    }
    ],
    slotRequired: 1,
    isPersistent: true
  ...
  // 153. 猫鼬大师的神龛
  {
    ...
    effects: [
    {
      ...
      value: 1,
      targetCardType: 'unit',
      playCostMinBasePowerExclusive: 4,
      modifyPlayCostAllPlayers: true,
      description: '所有战力值超过4的单位牌费用+1'
    }
    ],
    slotRequired: 1,
    isPersistent: true
  ...
  // 154. 挖掘
  {
    ...
    effects: [
    {
      timing: 'onReveal',
      type: 'peekDeckBottom',
      peekDeckPlayer: 'random',
      peekTake: true,
      description: '揭示：从随机一名玩家的牌库底部抽取一张卡牌加入手牌'
    }
    ],
    slotRequired: 1,
    isPersistent: false
  ...
  // 155. 奇美拉
  {
    ...
    effects: [
    {
      ...
      batchResolveOnly: true,
      description: '揭示：将你的场上每张卡牌的属性变为随机属性'
    }
    ],
    slotRequired: 1,
    isPersistent: true
...
export class CardDatabase {
  ...
  static initialize() {
    allCardDefinitions.forEach(card => {
  ...
  static getByType(type: string): Card[] {
    const results: Card[] = []
    for (const card of this.cards.values()) {
      if (card.type === type) {
        results.push(card)
  ...
  static getByAttribute(attribute: string): Card[] {
    const results: Card[] = []
    for (const card of this.cards.values()) {
  ...
  // Legacy API (backward compatible with existing cards.ts)
  ...
  static get(id: string): Card | undefined {
    ...
    return { ...card, keywords: [...card.keywords], effects: [...card.effects], currentPower: card.basePower, stackedBonus: 0 }
  }
