...
export const INTENT_RULES = [
  {
    ...
    patterns: [
      ...
      /雷恩王国|年代记|地图志|斯诺德地图/,
      /九柱神|正神|异教神|邪恶神|宗教信仰/,
      /公正与荣耀|生命与丰饶|战争与谋略|火焰与锻造|知识与智慧|艺术与创造/,
      /拜伦帝国|荒漠地|轻语森林|城市联盟|斯特纳森|矮人诸族|特里尔|泰瑟兰|阿瑞安|麦林/,
      /正义与怜悯|奥法评议|梅纳特|露塔莉娅|卡德纳斯|利剑中队|铁脊关|长河宗|残阳寺|银匕|谋杀屋|五海王者/,
      /上古年代|辉煌年代|混乱年代|灰色年代|曙光年代/,
      /雷恩.*节日|新年（|光明节|绿草节|仲夏节|冬幕节|加冕日/,
      /雷恩.*神|有哪些.*正神|古老的文明|周边政权|组织势力/,
          /\u5317\u5883|\u5357\u5883|\u897f\u5883|\u4e1c\u5883|\u56db\u5883|\u9996\u90fd|\u738b\u90fd|\u541b\u51a0\u57ce|\u4e3b\u8981\u57ce\u5e02|\u6700\u5927\u7684\u57ce\u5e02|\u57ce\u5e02\u4e0e\u57ce\u9547|\u57ce\u9547\u540d\u5f55|\u56fd\u571f|\u5730\u57df\u4e0e\u5f62\u52bf|\u4ecb\u7ecd\u4e00\u4e0b.*\u5883|.*\u5883.*\u4ecb\u7ecd/,
      /君冠城|白霜城|冬怒堡|嚎叫湾|洛克镇|箭谷镇|寒鸦镇|边陲镇|绿河谷镇|银烛城|砰砰城|威斯威尔|烬铁镇|布雷泽火焰-能源集团|灰隼镇|纺锤镇|金穗城|鹅湾|晴风郡|紫藤堡|绿野镇|河谷镇|暖径镇|赤戟城|阳葵城|牛堡|旧城|跳鼠镇|狼毒镇|红杈三角洲|沙枣镇与怪柳镇|道路系统|关卡与登记|交通方式|怎么走|如何前往|从.*出发|前往.*(?:城|镇|堡|湾)|行程|旅途|旅行|环游|旅游|观光|值得去|游玩|游览|目的地|名胜|景点/,
],
    layers: ['L7'],
    topK: { L7: 14 },
