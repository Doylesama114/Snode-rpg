...
console.log('=== validate-advisor-combat-scan (7083) ===\n');
...
console.log(`\n7083 scan-v2: ${report.stats.pendingByTier.A} Tier-A · ${report.stats.pendingByTier.B} Tier-B · ${report.stats.pendingByTier.C} Tier-C · ${report.stats.pendingByTier.D} Tier-D pending`);
