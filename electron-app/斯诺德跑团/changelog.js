...
var SNOWD_CHANGELOG = [

  {
    ...
    date: '2026-08-11',
    changes: [
      '世界观架构内容更新（29张插图随文渲染、宗主名标粗18个、地图志双图）',
      '世界观检索L7 lore重建188块'
    ]
  },
...

  {
    ...
    date: '2026-08-11',
    changes: [
      '牧师神圣领域新增公正与荣耀之神（耀光/圣洁/自省三风格、2起始专长+15技能、标识颜色完整）',
      '神祇法表已公布7/10（锁定3）',
      'search-index 2532'
    ]
  },
...

  {
    ...
    date: '2026-08-10',
    changes: [
      '吟游诗人/游荡者/萨满祭司技能数据对照docx修正（阶位/风格/缺失技能）',
      '已公布进阶详情全量入库55条（冰霜法师补全+狂热十字军/刺客/防御者/青龙尊者/朱鹤尊者新增）',
      '进阶页6处详情解锁',
      'advisor进阶技能库27→55 documented',
      '提交世界观与进阶源docx'
    ]
  },

  {
    ...
    date: '2026-08-08',
    changes: [
      '恢复特殊专长页与职业页正文标识 ● 的 docx 颜色（特别彩蛋/荒野共生/龙棋选手等）',
      '修复多色标识只显示首色的问题，标识行按 docx 颜色逐色显示',
      '修复法师虹光射线额外条件 7 色标识丢失、奇械师起始特性图纸未渲染',
      '新增标识颜色审计脚本，全量页面自动校验颜色无丢失'
    ]
  },
  {
    version: '1.0.7195',
    date: '2026-08-08',
    changes: [
      '特殊专长页全新改版：100 个专长按 8 类分组展示，卡片结构化为前置条件/引言/效果条目/特殊条款',
      '新增分类筛选与折叠目录导航，保留搜索与颜色筛选',
      '特殊专长数据新增分类/标签/效果拆分字段，docx 同步管线同步升级'
    ]
  },
  {
    version: '1.0.7194',
    date: '2026-08-08',
    changes: [
      '修复桌面 AI 顾问聊天页点赞/点踩反馈无法上报的问题（改走 Electron IPC → FC → OSS）',
      '修复反馈定时拉取的 OSS 签名错误与报告首次生成未入库问题',
      '反馈拉取自动过滤管道测试数据，不再混入统计报告'
    ]
  },

  {
    ...
    date: '2026-08-07',
    changes: [
      '修复牧师神圣领域14个技能缺失的效果内容（战争潮流/冲锋/骑士臂甲/秘法锁/有用的小东西等共29行，按原docx补齐）'
    ]
  },
...

  {
    ...
    date: '2026-08-07',
    changes: [
      '职业页色彩标识筛选统一完整颜色表（14色，缺失色置灰不可点）',
      '新增玫红色标识色，修复战士施法者警戒丢失的玫红标识点'
    ]
  },
...

  {
    ...
    date: '2026-08-07',
    changes: [
      '图纸参考价格补齐：按官方参考价倒推治愈因子30金、动力岩30金、黑火药20金等材料价，闭合8条缺价参考价格；修复猎人9个与奇械师17个图纸技能研发材料行错位',
      '奇械师与牧师神圣领域图纸加工升级效果补齐55条，升级块分组展示（加工材料/参考价格/升级效果）',
      '召唤单位技能可读性优化：技能描述保留行结构，技能名独立标题、子项逐行列表，多技能单位分块清晰',
      '奇械师创建页装备选择改为A/B/C/D/E五类各选其一'
    ]
  },
...

  {
    ...
    date: '2026-08-06',
    changes: [
      '优化 AI 入口小贴士气泡：显示约15秒后自动消失，内容随机轮换（每5分钟一条），移动端气泡缩小不占屏'
    ]
  },
...

  {
    ...
    date: '2026-08-06',
    changes: [
      '新增 AI 顾问入口小贴士：悬浮球旁自动冒泡显示战斗小贴士与15条基础规则，每5分钟轮换一条，点击气泡换下一条，点击悬浮球进入聊天页'
    ]
  },
...

  {
    ...
    date: '2026-08-06',
    changes: [
      '修复：全部职业页技能描述/条件/效果/升级文本内的彩色标识丢失（含通用天赋树冥想、法师虹光射线、游荡者、奇械师等），按原 docx/JSON 颜色补全；清理武僧等页面误并入描述的「标识:●●」伪文本'
    ]
  },
...

  {
    ...
    date: '2026-08-06',
    changes: [
      '帮助页兼职规则修正：兼职规则表按冒险者基础规则.xlsx 校正全部不可兼职关系，职业兼容性改为稀疏红块矩阵（仅标红不可兼职，含图例/粘性表头/悬停提示），术士兼职要求补全'
    ]
  },
...

  {
    ...
    date: '2026-08-05',
    changes: [
      '修复：武僧页 45 个技能缺失标识颜色（对照基础职业-武僧.docx 补全），借醉反击补全第二个标识色；全部标识颜色与 docx 一致'
    ]
  },
...

  {
    ...
    date: '2026-08-05',
    changes: [
      '标识颜色修复生效确认：为所有职业页样式链接增加版本号，强制刷新各端缓存，确保绿色/浅蓝/黄/粉等浅色标识以真实颜色显示'
    ]
  },
...

  {
    ...
    date: '2026-08-05',
    changes: [
      '修复：职业页标识点颜色被黑色阴影整体压暗（武僧等浅色标识尤为明显），改为细描边保留真实颜色'
    ]
  },
...

  {
    ...
    date: '2026-08-05',
    changes: [
      '修复：武僧职业页结构错误——7 处阶位区块重复开标签导致风格互相嵌套、阶位锚点失效，已删除重复区块并补齐缺失的闭合标签'
    ]
  },
